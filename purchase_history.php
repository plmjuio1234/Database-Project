...
$sql = "SELECT p.Name, p.ImageURL, ph.Quantity, ph.PurchaseDate FROM PurchaseHistory ph JOIN Products p ON ph.ProductID = p.ProductID WHERE ph.UserID = ?";
        ...
        <div class="productcontent">
            ...
            <div class="html container-xl">
                    <div class="productbox col-md-12">
                        <div class="producttitle">구매 기록</div>
                                ...
                                <?php
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<img src='" . $row["ImageURL"] . "' alt='" . $row["Name"] . "' style='width:50px;'>";
                                            echo "<p>" . $row["Name"] . " - Quantity: " . $row["Quantity"] . " - Date: " . $row["PurchaseDate"] . "</p>";
                                            echo "</div>";
                                        }
                                    } else {
